...
<div class="container-fluid">
    ...
    <%
     ...
     %>
      ...
      <div class="dropdown">
      <div style="width:36px;height:36px;background-image:radial-gradient(circle,black 3.6px,transparent 4.6px); background-size:100% 33.33%;" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></div>
         
         <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
         <div class="dropdown-item" data-toggle="modal" data-target="#showprofilemodal"><b>My Profile</b></div>
         <div class="dropdown-item" data-toggle="modal" data-target=".changepasswordmodal"><b>Change Password</b></div>
         <div class="dropdown-item" data-toggle="modal" data-target=".logout-modal"><b>Logout</b></div>
      ...
      <%   }  %>
         ...
         <h3 style="margin-left:15px;">  <a class="navbar-brand" href="index.jsp"> <i><b>Mobile Mart</b></i></a> </h3>
      ...
      %>
       ...
       <%
           ...
           <li class="nav-item active dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
             <a class="dropdown-item" href="index.jsp?filter=10000">&#8377;10000</a>
             <a class="dropdown-item" href="index.jsp?filter=20000"> &#8377;20000</a>
             <a class="dropdown-item" href="index.jsp?filter=30000"> &#8377;30000</a>
             <a class="dropdown-item" href="index.jsp?filter=50000"> &#8377;50000</a>
             <a class="dropdown-item" href="index.jsp?filter=100000"> Over &#8377;100000</a>
            </div>
          ...
          <form class="form-inline my-2 my-lg-0"  method="post" action="ProductOperation" id="searchform">
            <input type="hidden" name="action" value="searchProduct" >
            <input class="form-control mr-md-2" type="text" placeholder="Search product" aria-label="Search" size="80" name="search">
...
<div class="modal fade" id="showmycartmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <tbody>
   ...
   %>
    <tr class="text-left">
      <td><img style="max-height:100px;max-width:120px;width:auto;" class="img-fluid mx-auto d-block" src="productImages/<%=p.getProductPhoto() %>" alt="users_pic" ></td>
  ...
  <tbody>
   ...
   %>
    <tr class="text-left">
      ...
      <td class="text-start"><%=p.getProductTitle() %></td>
      <td style="text-align:left;"><%=p.getProductDescription() %></td>
      <td class="mid-align"><%=new BrandDaoImp().getBrandNameById(p.getBrandId()) %></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phonee.png" style="width:27px;" alt="img">+91 8235937186<br>
                <img src="images/emaill.png" style="width:29px;" alt="img">nnr9798@gmail.com
            </b>
        </p>
        </div>
      </div>
